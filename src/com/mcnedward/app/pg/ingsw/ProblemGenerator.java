...
public class ProblemGenerator
{
    ...
    throws Exception
  {
    ...
    String file2 = paramArrayOfString[1];
    
//	System.out.println("Attempting to read file: " + file1);
...
//	System.out.println("Successfully created DataFile: " + file);
    ...
    localProperties2.store(localFileOutputStream, "Generated by ProblemGenerator [" + (localProblemInstance.validInstance() ? "Valid instance" : "Invalid instance") + "]");
